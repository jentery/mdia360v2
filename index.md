...
**Concepts**: abandonware, access, box art, collections, culturalization, edition, emulation, fair dealing or fair use, galleries, libraries, archives, and museums (GLAM), game magazines, game manuals, games as a service, hardware, localization, maintenance, media archaeology, metadata, migration, mods, ports, provenance, remakes and remasters, remediation, restoration, software, source code, and work-expression-manifestation-item  
